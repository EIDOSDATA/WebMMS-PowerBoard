...
void Port_ReFresh() // static inline void Port_ReFresh() // void Port_ReFresh() __attribute__((always_inline))
{
	// ON : 1, OFF : 07
...
void ResPonse_PSTAT(int p) //static inline void ResPonse_PSTAT(int p) // void ResPonse_PSTAT(int p) __attribute__((always_inline))
{
	Port_ReFresh();
	switch (p)
	{
